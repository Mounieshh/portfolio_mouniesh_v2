...
export const TextPressure = ({
  ...
  const dist = (a: { x: any; y: any; }, b: { x: any; y: any; }) => Math.hypot(b.x - a.x, b.y - a.y);
  ...
  const setSize = () => {
    ...
    requestAnimationFrame(() => {
      ...
      if (scale && textRect && typeof textRect.height === 'number' && textRect.height > 0) {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      const maxDist = titleRect && typeof titleRect.width === 'number' ? titleRect.width / 2 : 0;
